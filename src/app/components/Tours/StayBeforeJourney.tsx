...
export default function StayBeforeJourney() {
  ...
  <div className="py-10 md:py-20">
      <h1 className="text-[22px] md:text-[26px] text-[#1E3355] font-semibold mb-8">Top Stays in Mirissa & The South (Near the Attraction)</h1>
            {/* ✅ DESKTOP VIEW */}
        <div className="hidden md:grid sm:grid-cols-2 md:grid-cols-3 gap-6 text-left">
          {visible.map((item) => (
            <div key={item._id}>
