  ...
  return (
    <section className="relative py-10 md:py-20 overflow-hidden">
      ...
      <Container className="relative z-10 text-center">
        ...
        {/* Label */}
        <span className="inline-block text-label font-normal text-[10px] md:text-[14px] tracking-widest bg-gray-400/70 text-black px-4 py-1 rounded-full mb-4 z-30">
          WHY US
        </span>
        ...
        <div className="grid gap-4 md:gap-6 md:grid-cols-4">
          ...
          {features.map((item, i) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className="md:w-14 h-10 w-10 md:h-14 mx-auto mb-4 flex items-center justify-center rounded-full bg-[#1D4063] text-white">
                  <Icon size={22} />
                </div>

                {/* Title */}
                <h3 className="text-body-header text-[24px] md:text-[26px] text-center font-semibold text-[#1D4063] mb-4">
                  {item.title}
                </h3>
